...
public class ViewTributacaoIcms implements Serializable {
    ...
    @Transient
    //Todo colocar campo no banco
    private BigDecimal aliquotaFcp;

    public ViewTributacaoIcms() {
    }
    ...
    public boolean equals(Object obj) {
        ...
        final ViewTributacaoIcms other = (ViewTributacaoIcms) obj;
