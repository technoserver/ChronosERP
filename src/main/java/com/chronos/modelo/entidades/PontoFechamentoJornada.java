...
public class PontoFechamentoJornada implements Serializable {
   ...
   public Integer getIdTransient() {
      if (id != null) {
         return id;
      }
      if (idTransient == null) {
         idTransient = new Random().nextInt();
      }
      return idTransient;
   }

   public void setIdTransient(Integer idTrasient) {
      this.idTransient = idTrasient;
   }

   @Override
   public String toString() {
      return "PontoFechamentoJornada{" + "id=" + id + '}';
   }
