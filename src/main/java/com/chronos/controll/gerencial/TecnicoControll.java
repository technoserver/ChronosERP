...
import com.chronos.modelo.entidades.Tecnico;
...
@Named
@ViewScoped
public class TecnicoControll extends AbstractControll<Tecnico> implements Serializable {
    ...
    public void salvar() {
        ...
        boolean existeColaborador = getObjeto().getId() == null && dao.existeRegisro(Tecnico.class, "colaborador.id", getObjeto().getColaborador().getId());
    ...
    @Override
    protected Class<Tecnico> getClazz() {
