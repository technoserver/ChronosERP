...
public class CurrencyWriter {
    ...
    /**
     * O conversor reconhece números até a ordem dos setilhões, portanto, o maior valor suportado atualmente é o
     * representado abaixo.
     */
    ...
    /**
     * Nomes das grandezas numéricas no plural. O mapa a chave do mapa é o expoente de dez do número e o valor é o seu
     * nome no plural. Por exemplo: para chave 3 (10^3) o valor é "mil", para a chave 6 (10^6) o valor é "milhões", e
     * assim por diante. Os nomes foram obtidos de um artigo publicado na seção Dois Mais Dois na revista
     * SuperInteressante nº. 15, de dezembro de 1988 (Editora Abril, São Paulo/SP), disponível em
