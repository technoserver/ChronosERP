...
public class JsfLoginUrlAuthenticationEntryPoint implements AuthenticationEntryPoint, InitializingBean {
     ...
     * then the client will first be redirected to an https URL, even if <tt>serverSideRedirect</tt>
    ...
    /**
     * The URL where the <code>UsernamePasswordAuthenticationFilter</code> login page can be found. Should either be
