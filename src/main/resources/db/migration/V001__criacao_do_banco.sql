...
CREATE TABLE TRIBUT_OPERACAO_FISCAL (
  ...
  CFOP                         INTEGER,
  CONTROLAR_ESTOQUE_VERIFICADO BOOLEAN DEFAULT FALSE,
  GERAR_PIS_COFINS             BOOLEAN DEFAULT FALSE,
  GERAR_IPI                    BOOLEAN DEFAULT FALSE,
  GERAR_ISSQN                  BOOLEAN DEFAULT FALSE,
  OBSERVACAO                   TEXT,
  PRIMARY KEY (ID),
  FOREIGN KEY (ID_EMPRESA)
  REFERENCES EMPRESA (ID)
